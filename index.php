...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($username === $defaultUsername && $password === $defaultPassword) {
        ...
        header("Location: organiser-voyage.php");
        exit();
    } else {
        ...
        if ($_SESSION['login_attempts'] >= 3) {
            header("Location: jeux-detente.php");
            exit();
        }
    }
}
...
<section>
    <div class="intro">
        <div>
            ...
            <p>
                Notre agence de voyage offre un service de qualité. Vous pouvez organiser votre voyage en toute sécurité et simplicité.
            </p>
        </div>
    ...
    <div class="album-photos">
        <a href="https://en.wikipedia.org/wiki/Paris" target="_blank"><img src="img/paris.jpg" alt="Lieu 1" />
            <span>Paris</span>
        </a>
        <a href="https://en.wikipedia.org/wiki/Cairo" target="_blank"><img src="img/cairo.jpg" alt="Lieu 2" /><span>Cairo</span></a>
        <a href="https://ar.wikipedia.org/wiki/%D9%82%D8%B3%D9%86%D8%B7%D9%8A%D9%86%D8%A9" target="_blank"><img src="img/constantine.jpg" alt="Lieu 3" />
            <span>Constantine</span></a>
        <a href="https://en.wikipedia.org/wiki/Leaning_Tower_of_Pisa" target="_blank"><img src="img/pW3OGKV-leaning-tower-of-pisa-wallpaper.jpg" alt="Lieu 4" />
            <span> Pisa Tour</span>
        </a>
    </div>
</section>
